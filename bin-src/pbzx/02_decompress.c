// http://www.newosxbook.com/src.jl?tree=listings&file=/02_decompress.c
...
// This appears to have been misnamed, causing a linking error.
char *	decompressXZChunkToStdout(char *buf, int size, char *Into, int *IntoSize)
{
